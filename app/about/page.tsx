...
export default function About() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[80vh] flex items-center pt-40 overflow-hidden bg-surface-container-low">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 w-full">
          <div className="max-w-4xl space-y-8 md:space-y-10">
            ...
            <p className="text-primary font-headline font-bold text-xl tracking-tight !mt-6">
              ...
              We are a Digital Growth & Lead Capture Authority.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface-container-lowest p-10 rounded-3xl shadow-sm hover:shadow-premium transition-shadow">
